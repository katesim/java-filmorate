...
class FilmValidatorTest {
    ...
    void validate_filmData_isValid() {
        Film film = new Film(ID, NAME, DESCRIPTION, RELEASE_DATE, DURATION, MPA);
        FilmValidator.validate(film);
    }

    @Test
    void validate_nameIsEmpty_isNotValid() {
        Film film = new Film(ID, "", DESCRIPTION, RELEASE_DATE, DURATION, MPA);
    ...
    void validate_nameIsBlank_isNotValid() {
        Film film = new Film(ID, BLANK_STR, DESCRIPTION, RELEASE_DATE, DURATION, MPA);
    ...
    void validate_descriptionIsLongerThan200_isNotValid() {
        ...
        Film film = new Film(ID, BLANK_STR, longDescription, RELEASE_DATE, DURATION, MPA);
    ...
    void validate_releaseDateIsTooEarly_isNotValid() {
        ...
        Film film = new Film(ID, BLANK_STR, DESCRIPTION, releaseDate, DURATION, MPA);
    ...
    void validate_durationIsNegative_isNotValid() {
        Film film = new Film(ID, BLANK_STR, DESCRIPTION, RELEASE_DATE, -100, MPA);
    ...
    void validate_durationIsZero_isNotValid() {
        Film film = new Film(ID, BLANK_STR, DESCRIPTION, RELEASE_DATE, 0, MPA);
